...
void addTuioObject(TuioObject tobj) {
  ...
  if ( tobj.getSymbolID() == id1 ) {
    ...
    id11Presente = true;
  }else if ( tobj.getSymbolID() == id12 ) {
    xPuntero12 = tobj.getX() * width;
    yPuntero12 = tobj.getY() * height;
    angulo12 = tobj.getAngle();
    id12Presente = true;
  }
}
