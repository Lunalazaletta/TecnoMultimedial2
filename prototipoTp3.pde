...
void setup() {
  ...
  //inicializo la comunicación con TUIO
  ...
  if (pantalla == 1) {
   ...
   //   p2.deSeleccionar();
    ...
    if (posicionando) {
      ...
      textAlign(LEFT);
      rotate(PI/2);
      text("POSICIONA TUS FICHAS... "+(int(tiempoTurno/1000-(contador-contadorParcial)/1000))+" segundos restantes...", width/2-475,-550);
      pop();
...
void inicializar() {
  ...
  p1 = new Jugador(this, mundo, width/2-10, -100, width, height/2, 200, 120, true);
  p2 = new Jugador(this, mundo, width/2+10 ,height+100, 0, height/2, -200, width-200, false);
